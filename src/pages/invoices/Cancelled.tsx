...
import { getInvoices, sortInvoices, apiUrl } from '../../service/invoices';
...
const headCells: HeadCell[] = [
    ...
    { id: 'clientCompany', numeric: true, disablePadding: false, label: 'Client Company' },
...
export default function AllInvoices() {
    ...
    const moveProfile = (id: any) => {
        ...
        setSelect(null);
        if (id) {
            history.push(`/invoice-profile/${id}`);
        }
    };

    const intial = (page: number, rowsPerPage: number) => {
        getInvoices(page, rowsPerPage)
            .then((resp) => {
                setLoading(false);
    ...
    const handleRequestSort = (
        ...
        sortInvoices(page, rowsPerPage, property, x).then((resp) => {
            setLoading(false);
            setRows(resp.data.content);
        });
    };
                                ...
                                (row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align='right'>{row.clientCompany}</TableCell>
