...
import NewJourney from "./pages/journey-designer/NewJourney";
import NewBusinessCustomer from "./pages/business-customers/NewBusinessCustomer";
import ProductProfile from "./pages/product-catalog/ProductProfile";
import InvoiceProfile from "./pages/invoices/InvoiceProfile";
import BusinessCustomerProfile from "./pages/business-customers/BusinessCustomerProfile";
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route path="/invoice-profile/:id" component={InvoiceProfile} />
        ...
        <Route path="/business-customer-profile/:id" component={BusinessCustomerProfile} />
        <Route path="/new-business-customer" component={NewBusinessCustomer} />
        <Route path="/product-catalog" component={ProductCatalog} />
        <Route path="/new-product" component={NewProduct} />
        <Route path="/product-profile/:id" component={ProductProfile} />
